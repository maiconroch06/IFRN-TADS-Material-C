...
/*
    ...
    realizar pagamentos mensais fixos no valor de 10% da dívida inicial.
    
    Crie um programa em linguagem C que calcule e exiba quantos anos ou meses serão necessários
...
int main (void) {
    ...
    printf(" ===================================================\n\n");
    printf(" -> Informe o saldo do emprestimo: ");
